...
public struct ApacheSoftwareLicense20: License {
    ...
    public var summaryText: String {
        get {
            return LicenseContentFetcher.getContent(fromFileNamed: "asl_20_summary")
        }
    }
    ...
    public var fullText: String {
        get {
            return LicenseContentFetcher.getContent(fromFileNamed: "asl_20_full")
        }
    }
