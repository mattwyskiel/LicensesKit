...
public struct GnuGeneralPublicLicense20: License {
    ...
    public var summaryText: String {
        get {
            return LicenseContentFetcher.getContent(fromFileNamed: "gpl_20_summary")
        }
    }
    ...
    public var fullText: String {
        get {
            return LicenseContentFetcher.getContent(fromFileNamed: "gpl_20_full")
        }
    }
