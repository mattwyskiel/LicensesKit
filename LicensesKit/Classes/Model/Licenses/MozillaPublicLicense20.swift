...
public struct MozillaPublicLicense20: License {
    ...
    public var summaryText: String {
        get {
            return LicenseContentFetcher.getContent(fromFileNamed: "mpl_20_summary")
        }
    }
    ...
    public var fullText: String {
        get {
            return LicenseContentFetcher.getContent(fromFileNamed: "mpl_20_full")
        }
    }
